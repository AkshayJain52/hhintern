...
<html lang="en">
  <head>
    ...
    <title>Resume of Richard Hendriks</title>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div id="photo-header" class="text-center">
            <!-- PHOTO (AVATAR) -->
            <div id="photo">
              <img src="http:&#x2F;&#x2F;www.gravatar.com&#x2F;avatar&#x2F;0572f2d73025fd3009a79e7abee62b45?s=200&amp;r=pg&amp;d=mm" alt="avatar">
            </div>
            <div id="text-header" >
        ...
        <div class="col-xs-12 col-sm-7">
          ...
          <div class="box">
            ...
            <ul id="education" class="clearfix">
              <li>
                <div class="year pull-left">May, Dec,</div>
          ...
          <div class="box">
            ...
            <ul id="awards" class="clearfix">
              <li>
                <div class="year pull-left"> Oct </div>
                <div class="description pull-right">
                  <h3>Techcrunch</h3>
        ...
        <div class="col-xs-12 col-sm-5">
          ...
          <div class="box clearfix">
            ...
            <div class="contact-item">
              ...
              <div class="description pull-right">San Francisco, CA 94115 US</div>
            </div>
            <div class="contact-item">
            ...
            <div class="contact-item">
              ...
              <div class="title only pull-right"><a href="mailto:richard.hendriks@gmail.com" target="_blank">richard.hendriks@gmail.com</a></div>
            </div>
            <div class="contact-item">
            ...
            <div class="contact-item">
              ...
              <div class="description pull-right"><a href="https:&#x2F;&#x2F;twitter.com&#x2F;neutralthoughts" target="_blank">neutralthoughts</a></div>
            </div>
            <div class="contact-item">
