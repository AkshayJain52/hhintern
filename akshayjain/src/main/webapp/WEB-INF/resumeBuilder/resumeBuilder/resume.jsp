...
<body>
            ...
            <div class="container">
                ...
                <div class="navbar-offcanvas offcanvas ">
                    ...
                    <ul class="nav navbar-nav pull-sm-right">
                        <li><a href="resume.jsp" class="active">Make a Resume</a></li>
    ...
    <div class="container padding-tb-10 margin-top-15">
    ...
    <div class="clearfix"></div>
    <div class="container tab-container padding-sm-0 margin-top-15">
    <div class="col-xs-12 bg-primary padding-tb-10" style="z-index:9; border-bottom: 2px solid #2676bf;">
        ...
        <a href="#" class="btn btn-warning pull-right"><i class="fa fa-linkedin-square"></i> Import Profile from LinkedIn</a>
        <a href = "save-now" class = "btn btn-warning pull-right"><i class= "fa fa-linkedin-square"></i>save detail</a>
    </div>
    <div class="clearfix"></div>
        ...
        <div class="tab-content hidden-xs col-sm-10" id="myTabContent">
            <div id="Contact" class="tab-pane fade in active">
                <div class="col-xs-12 padding-tb-10 padding-xs-0">
                 <form action="save-now" method="" class="form-horizontal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-right">
                                <button class="btn btn-primary" name="save-now" type="submit">
                                    <span><i class="fa fa-save"></i> Save Detail</span>
                                </button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row padding-tb-10">
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" size="255" name="resume[firstname]" maxlength="255" id="resume_firstname" class="form-control">
                                    </div>
                                </div>
                    ...
                    <div class="col-xs-12 text-right">
                        <button class="btn btn-primary margin-lr-7 margin-tb-10"><i class="fa fa-save"></i> Save Detail</button>
                        <a  data-toggle="tab" class="btn btn-warning margin-tb-10" href="#Summary" >Save and Continue<i class="fa fa-chevron-right"></i></a>
            ...
            <div id="Summary" class="tab-pane fade">
                ...
                <form action="save-now" method="" class="form-horizontal">
                    ...
                    <div class="row padding-tb-10">
                        <div class="col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" size="255" name="resume[designation]" maxlength="255" id="resume_designation" class="form-control popoverEle" data-toggle="popover" data-trigger="focus" title="Dismissible popover" data-content="Web Designer, Sales Manager, Preschool Teacher, Administrative Assistant etc" data-placement="bottom" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="form-control editor"></div>
                                     <small class="help-block text-muted">Add a short summary about yourself highlighting your specialities and what value you can add for any employer. e.g. Target-driven sales professional with a proven track record of growing revenue & profit. Over 10 years of progressive experience in direct sales, channel sales and business development in the highly competitive segments of the consumer electronics industry.</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 text-right">
                        <button class="btn btn-primary margin-lr-7 margin-tb-10"><i class="fa fa-save"></i> Save Detail</button>
                        <a  data-toggle="tab"  class="btn btn-warning margin-tb-10" href="#Experience" >Save and Continue<i class="fa fa-chevron-right"></i></a>
            ...
            <div id="Experience" class="tab-pane fade">
              <div class="col-xs-12 padding-tb-10 padding-xs-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group form-block">
                                <label for="resume_experiences_0_end_date" class="text-center col-sm-4">End date</label>
                ...
                <div class="clearfix"></div>
                    ...
                    <div class="clearfix"></div>
                    <div class="col-xs-12 text-right">
                        <button class="btn btn-primary margin-lr-7 margin-tb-10 pull-left">
                        <i class="fa fa-plus-square "></i> Save And Add Another Experience</button>
					<a  data-toggle="tab" class="btn btn-warning margin-tb-10"  href="#Education" >Save and Continue<i class="fa fa-chevron-right"></i></a>
                    </div>
                    <div class="clearfix"></div>
             </form>
             </div>
              ...
              <div class="col-xs-12 padding-tb-10 padding-xs-0">
                ...
                <div class="clearfix"></div>
                    ...
                    <div class="col-xs-12 text-right">
                        <button class="btn btn-primary margin-lr-7 margin-tb-10 pull-left">
                        <i class="fa fa-plus-square "></i> Save And Add Another Experience</button>
                        <a  data-toggle="tab"  class="btn btn-warning margin-tb-10" href="#Skills" >Save and Continue<i class="fa fa-chevron-right"></i></a>
                    </div>
                    <div class="clearfix"></div>
            </form>
            </div>
            ...
            <div id="Skills" class="tab-pane fade">
              <div class="col-xs-12 padding-tb-10 padding-xs-0">
                ...
                <div class="clearfix"></div>
                    ...
                    <div class="col-xs-12 text-right">
                        <button class="btn btn-primary margin-lr-7 margin-tb-10 pull-left">
                        <i class="fa fa-plus-square "></i> Save And Add Another Skills</button>
                        <a  data-toggle="tab" class="btn btn-warning margin-tb-10" href="#Certifications" >Save and Continue<i class="fa fa-chevron-right"></i></a>
            ...
            <div class="col-xs-12 padding-tb-10 padding-xs-0">
               ...
               <div class="clearfix"></div>
                    ...
                    <div class="col-xs-12 text-right">
                        <button class="btn btn-primary margin-lr-7 margin-tb-10 pull-left">
                        <i class="fa fa-plus-square "></i> Save And Add Another Certifications</button>
                      <a  data-toggle="tab" class="btn btn-warning margin-tb-10" href="#Publications" >Save and Continue<i class="fa fa-chevron-right"></i></a>
            ...
            <div id="Publications" class="tab-pane fade">
                ...
                <div class="clearfix"></div>
                    ...
                    <div class="col-xs-12 text-right">
                        <button class="btn btn-primary margin-lr-7 margin-tb-10 pull-left">
                        <i class="fa fa-plus-square "></i> Save And Add Another Publications</button>
                      <a  data-toggle="tab" class="btn btn-warning margin-tb-10" href="#Projects" >Save and Continue<i class="fa fa-chevron-right"></i></a>
            ...
            <div class="col-xs-12 padding-tb-10 padding-xs-0">
                ...
                <div class="clearfix"></div>
                    ...
                    <div class="col-xs-12 text-right">
                        <button class="btn btn-primary margin-lr-7 margin-tb-10 pull-left">
                        <i class="fa fa-plus-square "></i> Save And Add Another Project</button>
                    <a  data-toggle="tab" class="btn btn-warning margin-tb-10" href="#Languages" >Save and Continue<i class="fa fa-chevron-right"></i></a>
            ...
            <div class="col-xs-12 padding-tb-10 padding-xs-0">
                ...
                <div class="clearfix"></div>
                    ...
                    <div class="col-xs-12 text-right">
                        <button class="btn btn-primary margin-lr-7 margin-tb-10 pull-left">
                        <i class="fa fa-plus-square "></i> Save And Add Another Language</button>
                     
                      <a  data-toggle="tab" class="btn btn-warning margin-tb-10" href="#Volunteerings" >Save and Continue<i class="fa fa-chevron-right"></i></a>
            ...
            <div class="col-xs-12 padding-tb-10 padding-xs-0">
                ...
                <div class="clearfix"></div>
                    ...
                    <div class="col-xs-12 text-right">
                        <button class="btn btn-primary margin-lr-7 margin-tb-10 pull-left">
                        <i class="fa fa-plus-square "></i> Save And Add Another Volunteerings</button>
                       <a  data-toggle="tab" class="btn btn-warning margin-tb-10" href="#Recommendations" >Save and Continue<i class="fa fa-chevron-right"></i></a>
            ...
            <div class="col-xs-12 padding-tb-10 padding-xs-0">
                ...
                <div class="clearfix"></div>
                    ...
                    <div class="col-xs-12 text-right">
                        <button class="btn btn-primary margin-lr-7 margin-tb-10 pull-left">
                        <i class="fa fa-plus-square "></i> Save And Add Another Recommendations</button>
     
                    <a  data-toggle="tab" class="btn btn-warning margin-tb-10" href="#Honors" >Save and Continue<i class="fa fa-chevron-right"></i></a>
            ...
            <div id="Honors" class="tab-pane fade">
                ...
                <div class="clearfix"></div>
                    ...
                    <div class="col-xs-12 text-right">
                        <button class="btn btn-primary margin-lr-7 margin-tb-10 pull-left">
                        <i class="fa fa-plus-square "></i> Save And Add Another Honors</button>
                        <button class="btn btn-warning margin-tb-10">Save and Continue <i class="fa fa-chevron-right"></i></button>
